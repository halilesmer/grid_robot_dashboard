...
def render_zone_controls(account_id: str, zones: list):
    ...
    # Mevcut komutları oku (eğer varsa)
    current_commands = {}
    ...
    for idx, zone in enumerate(zones):
        ...
        with c4:
            if st.button("🗑️ Temizle", type="primary", key=f"clear_btn_{account_id}_{idx}", help=SETTINGS_TOOLTIPS.get("ZONE_CLEAR", "Bekleyen emirleri siler ve AÇIK POZİSYONLARI piyasa fiyatından kapatır.")):
                update_zone_command(idx, "CLEAR")
